...
public class TVShowFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ViewPager favViewPager = view.findViewById(R.id.tvShow_pager);
        VPAdapter adapter = new VPAdapter(getChildFragmentManager());
        adapter.addFragment(new ItemTVShowFragment(), getString(R.string.nav_tvshow));
        adapter.addFragment(new ItemFavTVShowFragment(), getString(R.string.nav_fav));
